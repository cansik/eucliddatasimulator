...
from euclidwf.framework.workflow_dsl import pipeline, nested
...
def vis_two_steps_nested(quadrant, master_dark, master_flat, control_params):
    quadrant_flat_corr, hot_pixels_map, dead_pixels_map = \
                    correct(quadrant=quadrant, master_dark=master_dark, 
